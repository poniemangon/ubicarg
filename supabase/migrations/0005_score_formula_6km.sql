...
--
-- Scoring formula, take 3: 100 pts within 1km unchanged, falloff beyond
-- that eased again from -1 pt/4km to -1 pt/6km. Client-side match:
-- scoreForDistance() in src/App.jsx. Self-contained — safe to run
-- regardless of whether 0002/0004's versions ran first, since create or
-- replace just redefines these from scratch each time.
